        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryTownStreet = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Watchings = table.Column<long>(type: "bigint", nullable: false),
                    Link = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    Describe = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Goods_Clients_RieltorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Floors = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Apartments_Goods_GoodId",
                        column: x => x.GoodId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, "admin", "admin", "admin", null });

            migrationBuilder.CreateIndex(
                name: "IX_Apartments_GoodId",
                table: "Apartments",
                column: "GoodId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Goods_RieltorId",
                table: "Goods",
                column: "RieltorId");
